...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.google_oauth2'
        db.add_column(u'app_user', 'google_oauth2',
                      self.gf('django.db.models.fields.CharField')(max_length=2048, null=True),
                      keep_default=False)


        # Changing field 'User.registration_id'
        db.alter_column(u'app_user', 'registration_id', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True))

    def backwards(self, orm):
        # Deleting field 'User.google_oauth2'
        db.delete_column(u'app_user', 'google_oauth2')


        # Changing field 'User.registration_id'
        db.alter_column(u'app_user', 'registration_id', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
